...
data class CryptoDto(
    val data: List<CryptoDetailsDto?>?,
    val status: CryptoStatusDto?
)
...
//    val maxSupply: Long?,
    ...
    val platform: CryptoPlatformDto?,
    val quote: CryptoQuoteDto?,
...
data class CryptoQuoteDto(
    @SerializedName("USD")
    val usd: CryptoUsdDto
)

data class CryptoUsdDto(
