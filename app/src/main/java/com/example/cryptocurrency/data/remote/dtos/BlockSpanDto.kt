...
data class BlockSpanDto(
    val chain: String?,
    val cursor: String?,
    val exchange: String?,
    @SerializedName("per_page")
    val perPage: String?,
    val results: List<BlockSpanResultDto?>?,
    val total: Int?
)

data class BlockSpanResultDto(
    @SerializedName("banner_image_url")
    val bannerImageUrl: String?,
    @SerializedName("chat_url")
    val chatUrl: Any?,
    val contracts: List<BlockSpanContractDto?>?,
...
data class BlockSpanContractDto(
    @SerializedName("contract_address")
    val contractAddress: String?
)

data class BlockSpanStatsDto(
